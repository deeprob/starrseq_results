...
#SBATCH -o /data7/deepro/starrseq/4_ml_classification_fragment_category/slurm/logs/out_run_%a.log # TODO: set slurm output file
#SBATCH -e /data7/deepro/starrseq/4_ml_classification_fragment_category/slurm/logs/err_run_%a.log # TODO: set slurm input file
...
smap_file="/data7/deepro/starrseq/4_ml_classification_fragment_category/slurm/files/run.txt"
...
python $peaker_path $dataset_path $genome_fasta $save_dir --encoder homer --classifier linear --homer_pwm_motifs $homer_motifs --homer_outdir "${save_dir}/homer/"
