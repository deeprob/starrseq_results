...
pred_file="${save_dir}homer_linear.csv.gz"
score_file="${save_dir}scores.csv"


python $peaker_path $dataset_path $genome_fasta $save_dir --test --encoder homer --classifier linear --homer_saved "${save_dir}/homer/motif_features.csv.gz"
