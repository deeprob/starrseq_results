...
LINE=$(sed -n "$SLURM_ARRAY_TASK_ID"p /data5/deepro/starrseq/papers/results/5_link_da_enhancers_to_de_genes/slurm/files/3_smap.txt)

echo $LINE
python /data5/deepro/starrseq/papers/results/5_link_da_enhancers_to_de_genes/src/ABC-Enhancer-Gene-Prediction/src/run.neighborhoods.py $LINE
